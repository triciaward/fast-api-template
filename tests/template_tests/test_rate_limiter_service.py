...
class TestRateLimiterInitialization:
    ...
    @patch("app.services.rate_limiter.Limiter")
    def test_get_limiter_redis_backend_available(self, mock_limiter, mock_get_redis, mock_settings):
    ...
    @patch("app.services.rate_limiter.get_redis_client")
    @patch("app.services.rate_limiter.Limiter")
    def test_get_limiter_redis_backend_unavailable(self, mock_limiter, mock_get_redis, mock_settings):
...
class TestRateLimitDecorators:
    ...
    @patch("app.services.rate_limiter.settings")
    @patch("app.services.rate_limiter.get_limiter")
    def test_rate_limit_email_verification_enabled(self, mock_get_limiter, mock_settings):
...
class TestRateLimiterInitialization:
    ...
    def test_setup_rate_limiting_enabled(self, mock_handler, mock_get_limiter, mock_settings):
        ...
        mock_app.add_exception_handler.assert_called_once_with(RateLimitExceeded, mock_handler)
...
class TestRateLimitInfo:
    ...
    def test_get_rate_limit_info_enabled_error(self, mock_get_remote_address, mock_settings):

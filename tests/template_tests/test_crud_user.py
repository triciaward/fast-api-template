...
class TestUserCRUDAsync:
    ...
    async def test_authenticate_user_success(self):
        ...
        with patch("app.crud.user.get_user_by_email") as mock_get_user:
            with patch("app.crud.user.verify_password") as mock_verify:
                ...
                # Test
                result = await authenticate_user(mock_db, "test@example.com", "password123")
    ...
    async def test_authenticate_user_not_found(self):
        ...
        with patch("app.crud.user.get_user_by_email") as mock_get_user:
            ...
            # Test
            result = await authenticate_user(mock_db, "nonexistent@example.com", "password123")
    ...
    def test_authenticate_user_sync_success(self):
        ...
        with patch("app.crud.user.get_user_by_email_sync") as mock_get_user:
            with patch("app.crud.user.verify_password") as mock_verify:
                ...
                # Test
                result = authenticate_user_sync(mock_db, "test@example.com", "password123")
...
class TestUserTokenOperations:
    ...
    def test_update_verification_token_sync(self):
        ...
        result = update_verification_token_sync(mock_db, "user_id", "new_token", expires)
    ...
    def test_update_password_reset_token_sync(self):
        ...
        result = update_password_reset_token_sync(mock_db, "user_id", "new_reset_token", expires)
...
class TestUserDeletionOperations:
    ...
    def test_update_deletion_token_sync(self):
        ...
        result = update_deletion_token_sync(mock_db, "user_id", "new_deletion_token", expires)

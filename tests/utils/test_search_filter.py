...
def test_text_search_contains_case_insensitive():
    ...
    config = SearchFilterConfig(text_search=create_text_search("Alice", ["username", "email"]))
...
def test_field_filters_and_sorting():
    ...
    filters = [
        ...
        create_field_filter("date_created", FilterOperator.GREATER_THAN_EQUAL, datetime(2025,1,1,tzinfo=timezone.utc)),
    ]

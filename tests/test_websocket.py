...
class TestConnectionManager:
    ...
    async def test_connect_new_room(self, connection_manager: ConnectionManager, mock_websocket: AsyncMock) -> None:
    ...
    async def test_connect_existing_room(self, connection_manager: ConnectionManager, mock_websocket: AsyncMock) -> None:
    ...
    async def test_connect_default_room(self, connection_manager: ConnectionManager, mock_websocket: AsyncMock) -> None:
    ...
    def test_disconnect_existing_connection(self, connection_manager: ConnectionManager, mock_websocket: AsyncMock) -> None:
    ...
    def test_disconnect_nonexistent_room(self, connection_manager: ConnectionManager, mock_websocket: AsyncMock) -> None:
        """Test disconnecting from a room that doesn't exist."""
        connection_manager.disconnect(mock_websocket, "nonexistent-room")
        # Should not raise any exceptions

    def test_disconnect_remove_empty_room(self, connection_manager: ConnectionManager, mock_websocket: AsyncMock) -> None:
    ...
    async def test_send_personal_message_success(self, connection_manager: ConnectionManager, mock_websocket: AsyncMock) -> None:
    ...
    async def test_send_personal_message_error(self, connection_manager: ConnectionManager, mock_websocket: AsyncMock) -> None:
    ...
    async def test_broadcast_empty_room(self, connection_manager: ConnectionManager) -> None:
    ...
    async def test_broadcast_success(self, connection_manager: ConnectionManager) -> None:
        ...
        connection_manager.active_connections["test-room"] = {
            mock_websocket1, mock_websocket2}
    ...
    async def test_broadcast_with_disconnected_websocket(self, connection_manager: ConnectionManager) -> None:
    ...
    def test_get_connection_count_empty_room(self, connection_manager: ConnectionManager) -> None:
        """Test getting connection count for empty room."""
        count = connection_manager.get_connection_count("empty-room")
        assert count == 0

    def test_get_connection_count_existing_room(self, connection_manager: ConnectionManager) -> None:
    ...
    def test_get_total_connections_empty(self, connection_manager: ConnectionManager) -> None:
        """Test getting total connections when none exist."""
        total = connection_manager.get_total_connections()
        assert total == 0

    def test_get_total_connections_multiple_rooms(self, connection_manager: ConnectionManager) -> None:

...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_user_password_reset_token", "users", ["password_reset_token"], unique=False
    )
    op.create_index(
        "ix_user_status",
        "users",
        ["is_deleted", "is_verified", "is_superuser"],
        unique=False,
    )
    op.create_index(
        "ix_user_verification_token", "users", ["verification_token"], unique=False
    )
    ...
    op.create_index(
        "ix_api_key_fingerprint", "api_keys", ["key_fingerprint"], unique=False
    )
    op.create_index(
        "ix_api_key_scopes",
        "api_keys",
    ...
    op.create_index(
        "ix_api_key_system", "api_keys", ["is_active", "expires_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_api_keys_key_fingerprint"),
        "api_keys",
        ["key_fingerprint"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_api_keys_updated_at"), "api_keys", ["updated_at"], unique=False
    )
    op.create_index(op.f("ix_api_keys_user_id"), "api_keys", ["user_id"], unique=False)
    op.create_table(
        "audit_logs",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Audit log entry unique identifier"
        ),
        sa.Column(
            "timestamp",
            postgresql.TIMESTAMP(timezone=True),
    ...
    op.create_index(
        "ix_audit_log_ip_timestamp",
        "audit_logs",
        ["ip_address", "timestamp"],
        unique=False,
    )
    op.create_index(
        "ix_audit_log_session_timestamp",
        "audit_logs",
        ["session_id", "timestamp"],
        unique=False,
    )
    op.create_index(
        "ix_audit_log_timestamp_user",
        "audit_logs",
        ["timestamp", "user_id"],
        unique=False,
    )
    ...
    op.create_table(
        "refresh_tokens",
        sa.Column(
            "id", sa.UUID(), nullable=False, comment="Refresh token unique identifier"
        ),
        sa.Column(
            "user_id",
            sa.UUID(),
    ...
    op.create_index(
        "ix_refresh_token_fingerprint",
        "refresh_tokens",
        ["token_fingerprint"],
        unique=False,
    )
    op.create_index(
        "ix_refresh_token_ip_timestamp",
        "refresh_tokens",
    ...
    op.create_index(
        op.f("ix_refresh_tokens_ip_address"),
        "refresh_tokens",
        ["ip_address"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_refresh_tokens_token_fingerprint"),
        "refresh_tokens",
        ["token_fingerprint"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_refresh_tokens_token_fingerprint"), table_name="refresh_tokens"
    )
